import { defaultCenteredWindowSize, yabai, terminalNotifier } from "./parameters.mjs"
...
export async function toggleWindowCenterBasic() {
    ...
    res ? await $`${yabai} -m window --toggle float && ${yabai} -m window --grid ${defaultCenteredWindowSize}` : await $`${yabai} -m window --toggle float`
}
