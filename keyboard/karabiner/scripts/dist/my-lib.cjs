...
const hyperNav = flat__default["default"](hyperNavigationRules, { maxDepth: 3 });
const originNav = flat__default["default"](originNavigationRules, { maxDepth: 3 });
...
exports.getComplexRules = getComplexRules;
